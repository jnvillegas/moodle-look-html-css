...
const Footer = () => {
  return (
    <footer className="bg-agencia-darkBlue text-white py-12 px-6">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          <div className="mb-8 md:mb-0">
            <div className="text-2xl font-bold flex items-center mb-6">
              <span className="code-tag mr-1">&lt;/&gt;</span>
              <span>agencia<span className="text-agencia-red">·i</span></span>
            </div>
            <div className="max-w-xs text-sm opacity-70">
              Innovamos para crear soluciones tecnológicas que transforman el futuro
              de la educación y el desarrollo profesional.
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Masterclass</a></li>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <div className="text-xs text-gray-500 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} agencia·i — Todos los derechos reservados
          </div>
